...
const WORKFLOW_KEYS = ['version', 'name', 'env', 'targets', 'toolchain', 'jobs', 'steps']
const JOB_KEYS = ['name', 'targets', 'toolchain', 'env', 'needs', 'steps']
...
function normalizeJob(id, raw, ctx) {
  ...
  return Object.freeze({
    ...
    toolchain: raw.toolchain === undefined ? ctx.toolchain : String(raw.toolchain),
...
function parse(source, opts = {}) {
  ...
  const ctx = {
    ...
    toolchain: doc.toolchain === undefined ? null : String(doc.toolchain)
  }
